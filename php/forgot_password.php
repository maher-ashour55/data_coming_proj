...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->rowCount() > 0) {
        ...
        $reset_link = "http://localhost/web2025/data_coming_proj/php/reset_password.php?token=$token";
        ...
        try {
            ...
            $mail->Password = 'zsfpmrackwswronn'; // App Password
            $mail->SMTPSecure = 'tls';
            $mail->Port = 587;
